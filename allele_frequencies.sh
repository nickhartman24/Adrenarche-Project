...
This requires a prepared positions.txt file as an input. This file should have 4 columns (Chr, pos, REF, ALT). I used tabs to separate columns, and I did not use headers. 
